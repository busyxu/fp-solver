...
void Z3ASTVisitor::visit(Z3ASTHandle e) {
  ...
  // jfs add by zgf to support fpa_to_ieee_bv
  case Z3_OP_FPA_TO_IEEE_BV:
  ACTION(visitConvertToIEEEBitVectorFromFloat(asApp))
  ...
  case Z3_OP_SELECT:
    ACTION(visitBvSelect(asApp))
  case Z3_OP_STORE:
    ACTION(visitBvStore(asApp))
