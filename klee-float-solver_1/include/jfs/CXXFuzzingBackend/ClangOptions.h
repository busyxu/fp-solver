...
struct ClangOptions {
  ...
  // jfs add by zgf to set test_no_main.o as uninterpreter funciton
  //std::vector<std::string> pathToTargetNoMainObj;
  std::vector<std::string> targetLinkedLibs;
  std::string pathToFPCheckLib;
