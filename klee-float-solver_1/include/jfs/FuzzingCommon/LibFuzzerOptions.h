...
struct LibFuzzerOptions {
  ...
  // jfs add by zgf : to set LibFuzzer max_total_time
  uint64_t maxTotalTime;  // Corresponds to `-max_total_time` option
  bool useClangCoverage;  // Corresponds to `-use_clang_coverage` option
  bool useCounters;       // Corresponds to `-use_counters' option
  bool useValueProfile;   // Corresponds to `-use_value_profile' option
