...
public:
  ...
  bool isArrayTy() const; // jfs add by zgf
...
public:
  ...
  bool isArrayVariable() const; // jfs add by zgf
  bool isConstArray() const; // jfs add by zgf
  bool isConstArraySelect() const; // jfs add by zgf
  ...
  static Z3ASTHandle getFloatInfinity(Z3SortHandle soroundNearestTiesToEvenrt, bool positive = true);
