...
template<>
Node NodeManager::mkConst<Rational>(const Rational& val) = delete;

template<>
Node NodeManager::mkConst<RealAlgebraicNumber>(const RealAlgebraicNumber& val) = delete;

template<>
Node NodeManager::mkConst<ProjectOp>(const ProjectOp& val) = delete;
