...
double olver_B0(double z, double abs_zeta)
{
  if(z < 0.98) {
...
double olver_B1(double z, double abs_zeta)
{
  if(z < 0.88) {
    const double t   = 1.0/sqrt(1.0-z*z);
    const double t2  = t*t;
...
double olver_A1(double z, double abs_zeta, double * err)
{
  if(z < 0.98) {
...
double olver_A2(double z, double abs_zeta)
{
  if(z < 0.88) {
    double t  = 1.0/sqrt(1.0-z*z);
    double t2 = t*t;
...
double olver_Asum(double nu, double z, double abs_zeta, double * err)
{
  double nu2 = nu*nu;
  double A1_err;
...
double olver_Bsum(double nu, double z, double abs_zeta)
{
  double nu2 = nu*nu;
