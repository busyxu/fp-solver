...
int main (void)
{
  ...
  double b[] = { 1.2, 0.2, 1.5, 0.2,1.2,0.2,1.2,0.3};
  double c[] = { 0.00, 0.00, 0.00, 0.00, 0,0,0,0};
...
*/
  ...
  gsl_blas_zher2k(CblasUpper, CblasNoTrans, alpha, &A.matrix, &B.matrix, beta, &C.matrix);
