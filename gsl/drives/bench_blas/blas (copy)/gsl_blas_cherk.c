...
int main (void)
{
  ...
  float a[] = { 0.11, 0.12, 0.13, 0.25, 0.11, 0.12, 0.13, 0.25};

  float b[] = { 0.21, 0.22, 0.23, 1022, 0.11, 0.12, 0.13, 0.25};
/*
...
*/
  ...
  int status = gsl_blas_cherk(CblasUpper, CblasNoTrans, 1.0, &A.matrix, 1.0, &B.matrix);
  printf("%d\n", status);
