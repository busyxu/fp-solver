...
int main (void)
{
  ...
  double a[] = { 0.11, 0.12, 0.13, 0.21, 0.22, 0.23, 1, 1};

  double b[] = { 1011, 1012, 1021, 1022, 1031, 1032, 1, 1};
...
*/
  gsl_vector_complex_view A = gsl_vector_complex_view_array(a, 4);
  gsl_vector_complex_view B = gsl_vector_complex_view_array(b, 4);
