...
main (void)
{
  ...
  klee_make_symbolic(&xtol, sizeof(xtol), "xtol");
  klee_make_symbolic(&gtol, sizeof(gtol), "gtol");
  klee_make_symbolic(&ftol, sizeof(ftol), "ftol");
...
//    printf ("data: %g %g %g\n", ti, y[i], si);
  ...
  gsl_multifit_nlinear_covar (J, epsrel, covar);
