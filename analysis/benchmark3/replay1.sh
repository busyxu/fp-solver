...
#KLEE_PATH="/home/aaa/fp-solver/klee-2.3"
...
# export LD_LIBRARY_PATH=/home/aaa/fp-solver/gsl/cblas/.libs:/home/aaa/fp-solver/gsl/.libs:/home/aaa/fp-solver/gsl_runtime_lib
...
# 将结果文件夹中的execute_time.txt中的运行时间结果写入到execute_time变量中，然后再写入result_file文件中
    ...
    #      -I/home/aaa/fp-solver/gsl -I/home/aaa/fp-solver/klee-2.3/include\
    #      -L/home/aaa/fp-solver/gsl_runtime_lib     -lgcov_preload \
    #      -L/home/aaa/fp-solver/gsl/cblas/.libs       -lgslcblas \
    #      -L/home/aaa/fp-solver/gsl/.libs        -lgsl \
    #      -L/home/aaa/fp-solver/gsl_runtime_lib     -lkleeRuntest \
...
#      if [ $? -eq 0 ]; then
#          echo "===>obj_gcov: "${obj_gcov}
#      else
#          echo "Copy failed"
#      fi
      echo "===>gcov_res: "${gcov_res}
...
#      cover_res=$(python3 ${GET_FUN_INFO_PY} ${driver_name} ${PWD}/${obj_gcov} ${PWD}/"temp.out")
      cover_res=$(python3 ${GET_FUN_INFO_PY} ${driver_name} ${gcov_res_path} ${PWD}/"temp.out")
      echo "===>cover_res:"${cover_res}
      rm temp.out
...
#    touch ${tempout}
    ...
    # get target function coverage in gsl.lib
    fin_cover_res=$(python3 ${GET_FUN_INFO_PY} ${driver_name} ${gcov_res_path} ${PWD}/"temp.out")
    echo  ${fin_cover_res}
#    rm temp.out
