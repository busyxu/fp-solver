...
public:
  ...
  // jfs add by zgf to record 'Array' variable max select size
  std::map<jfs::core::Z3ASTHandle,uint64_t> arrayVarWidth;
  std::map<jfs::core::Z3ASTHandle,uint64_t>::iterator arrayVarIter;
  // jfs add by zgf to support uninterpreter function
