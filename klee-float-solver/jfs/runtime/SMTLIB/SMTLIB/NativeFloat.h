...
// jfs add by zgf
jfs_nr_bitvector_ty jfs_nr_bitcast_float32_to_bv(const jfs_nr_float32 value);
jfs_nr_bitvector_ty jfs_nr_bitcast_float64_to_bv(const jfs_nr_float64 value);
...
bool jfs_nr_fadd_overflow_check(const double left, const double right);
bool jfs_nr_fadd_underflow_check(const double left, const double right);
bool jfs_nr_fsub_overflow_check(const double left, const double right);
bool jfs_nr_fsub_underflow_check(const double left, const double right);
bool jfs_nr_fmul_overflow_check(const double left, const double right);
bool jfs_nr_fmul_underflow_check(const double left, const double right);

bool jfs_nr_fdiv_overflow_check(const double left, const double right);
bool jfs_nr_fdiv_underflow_check(const double left, const double right);
bool jfs_nr_fdiv_invalid_check(const double left, const double right);
bool jfs_nr_fdiv_zero_check(const double left, const double right);
